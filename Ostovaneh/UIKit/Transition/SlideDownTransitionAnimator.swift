...
class SlideDownTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate  {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let offScreenUp = CGAffineTransform(translationX: 0, y: -container.frame.height) // - heigh
        let offScreenDown = CGAffineTransform(translationX: 0, y: container.frame.height) // to fix heigh in viewController
