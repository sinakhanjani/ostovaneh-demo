...
class CalendarViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        tblTasks.register(nibName, forCellReuseIdentifier: TodoTableViewCell.identifier_todo)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: TodoTableViewCell.identifier_todo, for: indexPath) as! TodoTableViewCell
